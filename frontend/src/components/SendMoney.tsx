...
export const SendMoney = () => { 
    return <div className="flex justify-content h-screen bg-gray-100">
        <div className="h-full flex flex-col justify-center">
            <div className="border h-min text-card-forground max-w-md p-4 space-y-8 w-96 bg-white shadow-lg rounded-lg">
                ...
                <div className="space-y-4">
                    ...
                    <button className="justify-center rounded-md text-sm font-medium ring-offset-background transition-colors h-10 py-2 w-full bg-green-500 text-white">
                        initail transfer
                    </button>
                </div>
            </div>
